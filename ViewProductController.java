...
import com.example.shopfiy.LoginRegistrationController;
import com.example.shopfiy.dao.CartDAO;
import com.example.shopfiy.dao.ProductDAO;
import com.example.shopfiy.dao.UserDAO;
...
public class ViewProductController implements Initializable {
    ...
    public void viewOrdersEmployee(){
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("com.example.shopfiy/view/OrderViewEmployee.fxml")
            );
    ...
    public void viewCart(){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("com.example.shopfiy/view/CartViewCustomer.fxml")
            );
            /*scene.setRoot((Parent) loader.load());*/
            AnchorPane root = (AnchorPane) loader.load();
