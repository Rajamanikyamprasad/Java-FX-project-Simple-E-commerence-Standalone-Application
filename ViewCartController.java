...
package com.example.shopfiy.Controller;

import com.example.shopfiy.dao.CartDAO;
import com.example.shopfiy.dao.CartDAO.CartTable;
import com.example.shopfiy.dao.OrderDAO;
import com.example.shopfiy.dao.ProductDAO;
import com.example.shopfiy.dao.ProductDAO.ProductTable;
import com.example.shopfiy.helper.ConfirmAlert;
import com.example.shopfiy.model.CartItem;
import com.example.shopfiy.model.Order;
import com.example.shopfiy.model.Product;
import com.example.shopfiy.model.User;
...
public class ViewCartController implements Initializable{
    ...
    public void backToProductView(){
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("com.example.shopfiy/view/ProductViewCustomer.fxml")
            );
    ...
    public void viewOrders(){
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("com.example.shopfiy/view/OrderViewCustomer.fxml")
            );
    ...
    public void logOut(){
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("com.example.shopfiy/view/UserLoginReg.fxml")
            );
            /*scene.setRoot((Parent) loader.load());*/
            AnchorPane root = (AnchorPane) loader.load();
            dialogStage.setTitle("Orders");
